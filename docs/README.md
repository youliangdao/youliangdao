...
| 2023 年 10 月<br>～<br>現在<br><br>(10 ヶ月間)        | フロントエンド開発基盤の整備<br><br>【担当業務】<br>・Storybook を導入し、テスト基盤を作成<br>・フロントエンドのビルド時間の短縮、Next.js 内部で使用されているコンパイラを Babel から Rust 製の SWC へ移行<br>・CI/CD の高速化。CI の並列化や不要コードを検知できる仕組みを導入<br>・ESLint・Prettier にいくつか独自ルールを追加し、フロントエンドの開発基盤を整備<br>・フロントエンドの開発環境 Docker 環境から Volta を用いたローカル環境開発へ移行し、生産性を向上<br>・ADR やコーディング規約、コンポーネント設計等を積極的にドキュメントに残して、開発者が開発しやすい環境を作る                                                                                                                                                                                                                              |                                                | TypeScript<br>Next.js<br>(Pages Router)<br>Storybook<br>Jest<br>React Testing Library<br>GitHub Actions             | 役割：リーダー<br>メンバー：2 人         |
| 2023 年 9 月<br>～<br>2023 年 11 月<br><br>(3 ヶ月間) | デザインシステムの構築とドキュメント整備、運用<br><br>【担当業務】<br>・shadcn/ui と TailwindCSS を用いたデザインシステムの構築作業<br>・Next.js(App Router)と ContentLayer を用いてデザインシステムのドキュメントを整備<br>・旧デザインシステム → 新デザインシステムへの移行作業および運用                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | UI/UX 設計<br>実装<br>テスト<br>運用<br>       | TypeScript<br>Next.js<br>(App Router)<br>ContentLayer<br>TailwindCSS<br>Storybook<br>                               | 役割：メンバー<br>メンバー：3 人         |
| 2023 年 7 月<br>～<br>現在<br><br>(1 年 2 ヶ月間)     | 導入企業のテナント募集サイトの新機能開発、保守、運用<br><br>【担当業務】<br>・ログインユーザーのマイページ機能を担当<br>・各種 SEO 対策の実装<br>・動作確認用ページを作成して、利用者の環境を確認しやすくする<br>・基盤ライブラリのアップデート対応<br>・募集サイト上にてお気に入りの区画を登録できるブックマーク機能を作成                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | 基本設計<br>詳細設計<br>実装<br>テスト<br>運用 | TypeScript<br>Next.js<br>(Pages Router)<br>TailwindCSS<br>CSS Modules<br>Jest<br>React Testing Library              | 役割：メンバー<br>メンバー：5 人         |
| 2023 年 6 月<br>～<br>現在<br><br>(1 年 3 ヶ月間)     | 商業施設向け Vertical SaaS の新機能開発、保守、運用<br><br>【担当業務】<br>・出店タスクや提出書類をテナントと共有してオンラインで進捗管理できるタスク管理機能のフロントエンドの実装<br>・各区画の稼働状況や空き状況を管理しやすくするためのカレンダー UI をリニューアル<br>・契約ごとの毎月の売上や収益を記録できる収入管理機能のフロントエンドの実装<br>・商業施設ごとや部署、スタッフごとにデータの閲覧・編集権限を分けられるようにするための権限機能のフロントエンド側を実装<br>・商談や契約の一覧データをユーザーが見やすい形に加工したり、自由に操作（フィルター・ソート）できるようにするためにテーブルビュー機能を開発。主にフロントエンド側の実装を担当<br>・Jest・React Testing Library・Storybook を用いた単体〜結合テストを幅広く実装<br>・Playwright を用いた E2E テストを、各テストシナリオごとに作成 | 基本設計<br>詳細設計<br>実装<br>テスト<br>運用 | TypeScript<br>Next.js<br>(Pages Router)<br>TailwindCSS<br>CSS Modules<br>Storybook<br>Jest<br>React Testing Library | 役割：スクラムマスター<br>メンバー：5 人 |

### 株式会社 Synergeee（副業：2024/02〜2024/05）

事業内容：B to B のパートナーセールス業界に特化した Vertical SaaS の企画・開発・運営。
資本金：- 円　売上高： - 円　従業員数：5 人　非上場

---

| 期間                                                 | 業務内容                                                                                                                                                                                                                                                                                                                                                                                    | 技術フェーズ                                      | 開発環境                                                                                | メンバー・役割                 |
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | --------------------------------------------------------------------------------------- | ------------------------------ |
| 2024 年 5 月<br>～<br>2024 年 7 月<br><br>(3 ヶ月間) | メール配信システムの構築<br><br>【担当業務】<br>・特定ドメイン宛に送信されたメールを収集するシステムの構築<br>・AWS SES・Lambda を用いたインフラ基盤の構築を主に担当<br>・Lambda 関数をコンテナイメージとともにデプロイし、Lambda 上で ORM を操作し、バックエンド側の DB に保存できるよう実装                                                                                               | 基本設計（DB 設計）<br>詳細設計<br>実装<br>テスト | TypeScript<br>(NestJS)<br>JavaScript<br>AWS Lambda<br>AWS SES<br>MySQL<br>Git<br>Docker | 役割：メンバー<br>チーム：5 名 |
| 2024 年 2 月<br>～<br>2024 年 4 月<br><br>(3 ヶ月間) | パートナーセールス向け SaaS の新機能開発担当<br><br>【担当業務】<br>・活動ログ機能のフロントエンド実装と DB 設計を担当<br>・ユーザー体験を損なわたいために GrahpQL による無限スクロール機能の実装<br>・パフォーマンス面を考慮して仮想スクロールを導入<br>・Slack や LINE のような慣れ親しんだ UI 設計にするために逆順スクロールを実装<br>・収集した活動ログを保存するための DB 設計も行った | 実装<br>テスト<br>                                | TypeScript<br>React<br>NestJS<br>GraphQL<br>MySQL<br>Git<br>Docker<br>                  | 役割：メンバー<br>チーム：5 名 |

## 最も苦労したプロジェクト

### プロジェクト名

商業施設向け Vertical SaaS の新機能開発（テーブルビュー機能の開発）

### プロジェクト概要

商業施設が自社スペースを掲載する「テナント募集サイト」と、問い合わせ・営業・テナント情報管理やスペースの稼働管理ができる「営業管理システム」を、開発なしで構築・利用することで、テナント募集業務の効率を上げるためのプロジェクト。主に募集サイトと管理システムの UI/UX の設計・実装を担当。

### 課題

管理システム上においてユーザーは契約や商談の一覧データから目的のデータを抽出したり操作することが難しい状況だった。たとえば、どのテナントとの商談に今週アプローチすべきなのか？を営業担当の方は把握しづらく、テナントとの商談が滞りやすいという課題を抱えていた。

### 工夫点

商談や契約の一覧データを自由に操作可能かつそこで抽出したデータを保存できるテーブルビュー機能を開発した。
開発する際は、企業によっては約 1 万件以上もの商談・契約データが存在しており、それらを自由に操作・加工できるよう事前にパフォーマンス面において検証作業を行う必要があった。
