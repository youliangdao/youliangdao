...
| 2023 年 7 月<br>～<br>現在<br><br>(1 年 2 ヶ月間)     | 導入企業のテナント募集サイトの新機能開発、保守、運用<br><br>【担当業務】<br>・ログインユーザーのマイページ機能を担当<br>・各種 SEO 対策の実装<br>・動作確認用ページを作成して、利用者の環境を確認しやすくする<br>・基盤ライブラリのアップデート対応                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | 基本設計<br>詳細設計<br>実装<br>テスト<br>運用 | TypeScript<br>Next.js<br>(Pages Router)<br>TailwindCSS<br>CSS Modules<br>Jest<br>React Testing Library              | 役割：メンバー<br>メンバー：5 人         |
