...
- 少人数（3~5 名ほど）のマネジメント経験あり
- スクラムマスターの経験あり
- ドキュメント作成
- テックブログ運営
- 未経験技術への迅速なキャッチアップ、アウトプット
- LT 登壇
- AWS クラウドプラクティショナー／LPIC1／基本情報技術者試験
...
### 株式会社 Synergeee（2024/02〜2024/05）

B to B のパートナーセールス業界に特化した Vertical SaaS を開発。

副業として参画し、メッセージ機能の画面作成や AWS Lambda と SES を用いたメール配信機能等を担当。

シード期スタートアップにあたるため、PO とのコミュニケーションなどを積極的に行い仕様のすり合わせなどを行いながら開発を進めていました。
...
さらに事業部制に移行してからは、リードエンジニア兼スクラムマスターとして 4 名のエンジニアをマネジメントしつつ各種スクラムイベントの運営をしておりました。
...
- プロジェクト詳細：
  ...
  - フルスクラッチでエクセルライクに使用可能なカレンダーを実装
    ...
    - 大量の施設データを扱う必要性があったため、パフォーマンス面を考慮し開発しました
  - 収入管理機能の実装
  - ダッシュボード機能の実装
...
- 1 メンバーとしての開発からリードエンジニアとしてメンバーの育成・マネジメントを行ってきた経験を活かしてチームの開発をよりよいものにしていくために、あらゆることをしていきたいと思っています
...
- ドキュメント作成・整備も得意で、最小限の運用負荷でドキュメント管理を行えるよう仕組みをつくることも可能です
